...
RUN apt-get update && apt-get install -y gnupg2 \
    ...
    && apt-get update && apt-get install -y build-essential g++ ffmpeg libsm6 libxext6 git ninja-build libglib2.0-0 libsm6 libxrender-dev libxext6 \
    && apt-get clean \
    && rm -rf /var/lib/apt/lists/* \
    && pip install openmim future tensorboard \
    ...
    && touch /root/.bashrc \
    && echo PATH="/ec2-user/scripts:\$PATH" >> /root/.bashrc
